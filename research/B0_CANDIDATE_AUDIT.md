...
> SUPERSEDED NOTE (2026-09-13): 本文为2026-09-12静态审计历史快照。此后用户已批准local DINO source + local checkpoint为必要infrastructure adaptation，不再要求online torch.hub bitwise/RNG equivalence。001A已完成，strict load和runtime路径有真实产物。本文旧B类待批准/待在线等价验证文字不再是当前阻塞。见BASELINE_CONTRACT追加决定和001A评审包。
