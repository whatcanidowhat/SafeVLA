...
Candidate audit update (2026-09-12): 独立候选静态审计已完成，见research/B0_CANDIDATE_AUDIT.md。B0-CANDIDATE-AUDIT本轮禁止smoke；本计划仍BLOCKED_PREFLIGHT，不自动改READY或启动。候选不再含开发worker额外查询，但DINO/资源/import与运行产物待人工批准后验证。
